...
def hoy_iso() -> str:
    """Fecha de hoy en formato YYYY-MM-DD (zona UTC)."""
...
def franjas():
    ...
    # Contar turnos activos de hoy por franja en una sola consulta
    turnos_hoy = (
    ...
    usados_por_franja: dict[int, int] = {}
    for t in turnos_hoy:
        fid = t["franja_id"]
...
def crear_turno():
    ...
    # Insertar turno (token = UUID generado por Supabase automáticamente)
    nuevo = (
        supabase.table("turnos")
        .insert({
